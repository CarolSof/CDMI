...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $contraseñaHash = password_hash($contraseña, PASSWORD_DEFAULT,[50]);

    // Preparar la consulta SQL
    $query = $conn->prepare("INSERT INTO usuarios (nombre, apellido, fecha_nacimiento, correo, telefono, contraseña, rol) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $query->bind_param("sssssss", $nombre, $apellido, $fecha_nacimiento, $correo, $telefono, $contraseñaHash, $rol);
