...
{   
    ...
    if ($request->has('contraseña')) {
        ...
        $usuario->imagen_perfil = 'imagenes_perfil/' . $filename; // Guardar la ruta relativa
    }
...
public function actualizarPerfil(Request $request)
{
    ...
    $validator = Validator::make($request->all(), [
        ...
        'imagen_perfil' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // validar imagen si se sube
        'contraseña' => [
            'nullable',
            'string',
            'min:8',
    ...
    // Solo actualiza campos si están presentes
